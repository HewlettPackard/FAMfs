...
#define UNIFYCR_CONFIGS \
    ...
    UNIFYCR_CFG(meta, release_committed, BOOL, on, "release committed stripes on unlink, truncate", NULL) \
    ...
    UNIFYCR_CFG(encode, rec_freeq_sz, INT, EENCODE_FREEQ_SZ, "Recovery free requests queue depth", NULL) \
